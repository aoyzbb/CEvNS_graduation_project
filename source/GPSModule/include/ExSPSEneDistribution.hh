...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        ExSPSEneDistribution.hh
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
#ifndef ExSPSEneDistribution_h
#define ExSPSEneDistribution_h 1
...
public:
	...
	void SetHistName(G4String);//
	void SetHistUnit(G4String);//
...
private:
    ...
    void GenerateExtHistEnergies(G4bool);//
...
private:
    ...
    G4String RootFileName, HistName, HistUnit;
    TFile* f;
    TH1* h;
