...
///////////////////////////////////////////////////////////////////////////////
//
// MODULE:        ExSPSPosDistribution.hh
//
// Version:      1.0
// Date:         5/02/04
// Author:       Fan Lei 
...
///////////////////////////////////////////////////////////////////////////////
//
#ifndef ExSPSPosDistribution_h
#define ExSPSPosDistribution_h 1

#include "G4Navigator.hh"
#include "G4SPSRandomGenerator.hh"

class ExSPSPosDistribution
{
  //
  friend class ExSPSAngDistribution;
public:
  ExSPSPosDistribution (); 
  ~ExSPSPosDistribution ();
  ...
  void SetParPhi(G4double);
  void ConfineSourceToVolume(G4String);
  inline G4String GetConfineVolume() {return VolName; };
  //
  void SetBiasRndm (G4SPSRandomGenerator* a) { posRndm = a ; };
  ...
  void CopyFromSPSP(ExSPSPosDistribution* pos0);
