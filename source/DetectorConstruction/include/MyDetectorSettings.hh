...
public:
    ...
    PrimaryDescription* GetPrimaryDescription() { return fPrimaryDescription; } 
    void SetPrimaryGen(const G4GDMLAuxListType *auxInfoList, G4String value); //<auxiliary auxtype="PrimaryGen" auxvalue="ParticleGun"> 注意这里是在userinfo里的。
...
private:
    ...
    PrimaryDescription *fPrimaryDescription = 0;
};
