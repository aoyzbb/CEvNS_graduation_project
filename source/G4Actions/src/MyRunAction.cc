    ...
    : fDetector(det)
{
    ...
    if(PGGeneratorList::GetInstance()->GetPGPSConfig().ExGPSEnable)
        fExGPSMessenger = ExGeneralParticleSourceMessenger::GetInstance(ExGeneralParticleSource::GetInstance());
