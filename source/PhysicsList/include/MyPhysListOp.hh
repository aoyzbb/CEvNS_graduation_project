...
#ifndef MyPhysListOp_h
#define MyPhysListOp_h 1
...
class MyPhysListOp : public G4OpticalPhysics
{
public:
    MyPhysListOp(G4int verbose = 0, const G4String &name = "Optical");
    virtual ~MyPhysListOp();
...
private:
    /// Not implemented
    MyPhysListOp(const MyPhysListOp &right);
    /// Not implemented
    MyPhysListOp &operator=(const MyPhysListOp &right);
